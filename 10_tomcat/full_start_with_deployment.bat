...
@call .\apache-ant-1.10.13-bin\apache-ant-1.10.13\bin\ant -buildfile .\war_and_move.xml
@call .\apache-ant-1.10.13-bin\apache-ant-1.10.13\bin\ant -buildfile .\start_tomcat.xml
@call .\apache-ant-1.10.13-bin\apache-ant-1.10.13\bin\ant -buildfile .\start_browser_and_call.xml
pause